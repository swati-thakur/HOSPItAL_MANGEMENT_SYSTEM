<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_doctor.aspx.cs" Inherits="Hospital_Management_System.add_doctor" %>
...
<tr bgcolor="black">
<th colspan="7"><h2><center>ADD DOCTOR FORM</center></h2></th>
</tr></table></center>
    ...
    <label for="specialisation_in"><b>Designation</b></label><br />
  <asp:DropDownList ID="DropDownList1" runat="server" Width="100%">
    ...
    <asp:Button ID="Button2" runat="server" Text="Add Doctor" BackColor="#094987" 
          ForeColor="White" Height="52px" Width="100%" onclick="Button2_Click"  />
    
      <br />
      <br />
      <asp:Label ID="Label11" runat="server" ForeColor="Blue" Text="Label" 
