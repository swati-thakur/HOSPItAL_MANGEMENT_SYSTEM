<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="change_doctor_password.aspx.cs" Inherits="Hospital_Management_System.change_patient_password" %>
...
<head>
                     ...
                     <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu" >
                           <li>
                              ...
                              <i class="fa fa-user"></i><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label>
                           </li>
 ...
 <center> <form id="Form1" action="" method="post" runat="server" style="color:Black;">
<div class="container"><center> <h2><b>CHANGE PASSWORD</b></h2></center></div>
<br />
    <div class="container">
      <label for="old"><b>OLD PASSWORD</b></label>
    <asp:TextBox ID="TextBox1"   
          runat="server" ForeColor="Black" TextMode="Password"></asp:TextBox>
    
    

      <br />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
          ControlToValidate="TextBox1" ErrorMessage="Enter password!!!" ForeColor="Blue"></asp:RequiredFieldValidator>
      <br />
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
          ControlToValidate="TextBox2" ErrorMessage="Enter password!!!" ForeColor="Blue"></asp:RequiredFieldValidator>
      <br />

    <label for="psw"><b>CONFIRM PASSWORD</b></label>
    <asp:TextBox
        ID="TextBox3" runat="server"  ForeColor="Black" TextMode="Password"></asp:TextBox>
        <br />
        <asp:CompareValidator ID="CompareValidator1" runat="server" ForeColor="Blue" ControlToCompare="TextBox2" ControlToValidate="TextBox3" ErrorMessage="password not match!!!!"></asp:CompareValidator>
      <br />
        
        
    <asp:Button ID="Button1" runat="server" Text="Save" BackColor="#33CCFF" 
          ForeColor="White" Height="52px" Width="50%" onclick="Button1_Click"  />
    
      <br />
      <br />
      <asp:Label ID="Label2" runat="server" ForeColor="Blue" Text="Label" 
