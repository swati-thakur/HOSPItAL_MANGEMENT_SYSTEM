<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="discharge_form.aspx.cs" Inherits="Hospital_Management_System.discharge_form" %>
...
<head>
      ...
      <title> Admin Panel | Discharge Form</title>
...
<tr bgcolor="black">
<th colspan="7"><h2><center>DISCHARGE FORM</center></h2></th>
</tr></table></center>
    ...
    <asp:TextBox ID="TextBox1"   
          runat="server" ForeColor="Black" Width="700px"></asp:TextBox>
      ...
      <br />
       <label for="id"><b>Patient Name</b></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 ...
 <label for="date"><b>Admit Date</b></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <asp:Button ID="Button1" runat="server" Text="Generate Bill" BackColor="#094987" 
     ...
     <asp:TextBox ID="TextBox6"   
      ...
      <br />
       <asp:Button ID="Button2" runat="server" Text="Discharge Patient" BackColor="#094987" 
          ForeColor="White" Height="52px" Width="50%" onclick="Button2_Click"   />
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <h2 style="color:White; background-color:Black; Height:52px; Width:99%;"><center>Discharge Patient Record</center></h2>
              <center>
