<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add_reports.aspx.cs" Inherits="Hospital_Management_System.Add_reports" %>
...
<head>
      ...
      <title> Admin Panel | Add Report</title>
...
<tr bgcolor="black">
<th colspan="7"><h2><center>ADD PATIENTS REPORTS</center></h2></th>
</tr></table></center>
    ...
    <label for="id"><b>PATIENT ID</b></label>&nbsp;&nbsp;&nbsp;&nbsp;<br />
    <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="true" 
                    onselectedindexchanged="DropDownList1_SelectedIndexChanged" Width="734px"></asp:DropDownList>
        <br />
      
      <br />
      <label for="name"><b>PATIENT NAME</b></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
    <asp:TextBox ID="TextBox1"   
          runat="server" ForeColor="Black" Width="734px"></asp:TextBox>

      <br />
      <br />
          <label for="report"><b>REPORTS</b></label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:FileUpload ID="FileUpload1" runat="server" class="btn btn-info form-control" Width="734px"></asp:FileUpload>
    ...
    <asp:Button ID="Button1" runat="server" Text="Add Reports" BackColor="#094987" 
     ...
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <h2 style="color:White; background-color:Black; Height:52px; Width:99%;"><center>LIST OF  REPORTS</center></h2>
              <center>
