...
{
    public partial class discharges_patient : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("select * from admit ORDER BY admit_id DESC ", con);
            SqlDataReader dr1 = cmd.ExecuteReader();
            table11.Append("<center><table style='width:1500px; heigth:auto;' class='table'>");
            table11.Append("<tr bgcolor='black'>");
            table11.Append("<th colspan='8'><center>Admitted Patient</center></h2></th>");
            table11.Append("</tr>");
            table11.Append("<tr>");
            table11.Append("<th bgcolor='#5DADE2'>ADMIT ID</th>");
            table11.Append("<th bgcolor='#5DADE2'>PATIENT ID</th>");
            table11.Append("<th bgcolor='#5DADE2'>PATIENT NAME</th>");
            table11.Append("<th bgcolor='#5DADE2'>ALLOCATED DOCTOR ID</th>");
            table11.Append("<th bgcolor='#5DADE2'>ALLOCATED DOCTOR NAME</th>");
            table11.Append("<th bgcolor='#5DADE2'>ROOM NUMBER</th>");
            table11.Append("<th bgcolor='#5DADE2'>DATE OF ADMIT</th>");
            ...
            if (dr1.HasRows)
            {
                while (dr1.Read())
                {
                    ...
                    table11.Append("<td>" + dr1[6] + "</td>");
                    table11.Append("<td>" + "<a href='discharge_form.aspx?admit_id=" + dr1[0] + "&" + Request.QueryString[0] + "'>" + "<button>" + "Discharge" + "</button>" + "</a></td>");
