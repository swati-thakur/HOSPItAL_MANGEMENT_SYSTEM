...
{
    public partial class approve_reject_doctor : System.Web.UI.Page
    {
        ...
        StringBuilder table12 = new StringBuilder();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            table12.AppendFormat("<a href='admin_dashboard.aspx?id=" + Request.QueryString[0] + "' class='logo'>");

            table12.AppendFormat("<h3 style='color:white;'>Admin Panel</h3>");

            table12.AppendFormat(" </a>");
            PlaceHolder13.Controls.Add(new Literal { Text = table12.ToString() });

            con.Open();
            SqlCommand cmd = new SqlCommand("select * from doctor_applications ORDER BY id DESC ", con);
            SqlDataReader dr1 = cmd.ExecuteReader();
            table11.Append("<table style='width:1500px; heigth:auto;' class='table'>");
            table11.Append("<tr bgcolor='black'>");
             table11.Append("<th colspan='8'><h2>APPROVE & REJECT DOCTOR APPLICATION</center></h2></th>");
             table11.Append("</tr>");
             table11.Append("<tr>");
             table11.Append("<th bgcolor='#5DADE2'>ID</th>");
            table11.Append("<th bgcolor='#5DADE2'>NAME</th>");
            table11.Append("<th bgcolor='#5DADE2'>EMAIL</th>");
            table11.Append("<th bgcolor='#5DADE2'>CV FILE</th>");
            table11.Append("<th bgcolor='#5DADE2'>APPLY_DATE</th>");
            table11.Append("<th bgcolor='#5DADE2'>STATUS</th>");
            ...
            if(dr1.HasRows)
            {
             ...
             table11.Append("<td>" + "<a href='update_application.aspx?id=" + dr1[0] + "&" + Request.QueryString[0] + "'>" + "<button>" + "Update" + "</button>" + "</a></td>");
