<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_patient.aspx.cs" Inherits="Hospital_Management_System.add_patient" %>
...
<head>
      ...
      <title> Admin Panel | Add Patient</title>
...
<tr bgcolor="black">
<th colspan="7"><h2><center>ADD PATIENT FORM</center></h2></th>
</tr></table></center>
    ...
    <asp:TextBox
        ID="TextBox2" runat="server"  ForeColor="Black" ></asp:TextBox>
        <br />
    ...
    <asp:TextBox
        ID="TextBox4" runat="server"  ForeColor="Black" ></asp:TextBox>
        <br />
    ...
    <asp:Button ID="Button2" runat="server" Text="Add Patient" BackColor="#094987" 
