<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_dashboard.aspx.cs" Inherits="Hospital_Management_System.admin_dashboard" %>
                     ...
                     <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu" >
                           <li>
                              ...
                              <i class="fa fa-user"></i>  <asp:Label ID="Label5" runat="server" Text="Label" ForeColor="Black"></asp:Label>
                           </li>
                     ...
                     <div id="cardbox1">
                        <div class="statistic-box">
                           ...
                           <div class="counter-number pull-right">
                              <asp:Label ID="Label1" runat="server" Text="Label" class="count-number"></asp:Label>
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                     <div id="cardbox2">
                        <div class="statistic-box">
                           ...
                           <div class="counter-number pull-right">
                              <asp:Label ID="Label2" runat="server" Text="Label" class="count-number"></asp:Label>
                              <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                              </span>
                           </div>
                           <h3>Patients</h3>
				  ...
				  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                     <div id="cardbox2">
                        <div class="statistic-box">
                           <i class="fa fa-user-secret fa-3x"></i>
                           <div class="counter-number pull-right">
                              <asp:Label ID="Label3" runat="server" Text="Label" class="count-number"></asp:Label> 
                              <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                              </span>
                           </div>
                           <h3>Employee</h3>
                  ...
                  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                     <div id="cardbox4">
                        <div class="statistic-box">
                           ...
                           <div class="counter-number pull-right">
                              <asp:Label ID="Label4" runat="server" Text="Label" class="count-number"></asp:Label>
                              <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                              </span>
                           </div>
                           <h3>Appointments</h3>
