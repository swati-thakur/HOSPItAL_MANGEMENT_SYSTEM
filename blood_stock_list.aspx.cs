...
{
    public partial class blood_stock_list : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("select * from blood_bank", con);
            SqlDataReader dr1 = cmd.ExecuteReader();
            table11.Append("<center><table style='width:1500px; heigth:auto;' class='table'>");
            table11.Append("<tr bgcolor='black'>");
             table11.Append("<th colspan='3'><center>BLOOD STOCK LIST</center></h2></th>");
             table11.Append("</tr>");
             table11.Append("<tr>");
             table11.Append("<th bgcolor='#5DADE2'>ID</th>");
            table11.Append("<th bgcolor='#5DADE2'>BLOOD GROUP</th>");
            table11.Append("<th bgcolor='#5DADE2'>NO OF BAGS</th>");
            table11.Append("</tr>");
            if(dr1.HasRows)
            {
                while(dr1.Read())
