...
{
    public partial class doctor_leave_list : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("select * from leave where doctor_id='"+Request.QueryString[0]+"'", con);
            SqlDataReader dr = cmd.ExecuteReader();
            table.Append("<center><table style='width:1000px; heigth:auto;' class='table'>");
            table.Append("<tr bgcolor='black'>");
            table.Append("<th colspan='6'><center>LEAVE LIST</center></h2></th>");
            table.Append("</tr>");
            table.Append("<tr>");
            table.Append("<th bgcolor='#5DADE2'>FROM DATE</th>");
            table.Append("<th bgcolor='#5DADE2'>NO OF DAYS</th>");
            table.Append("<th bgcolor='#5DADE2'>REASON</th>");
            table.Append("<th bgcolor='#5DADE2'>STATUS</th>");
