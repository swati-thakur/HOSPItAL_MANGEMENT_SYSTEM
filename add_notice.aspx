<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_notice.aspx.cs" Inherits="Hospital_Management_System.add_notice" %>
...
<head>
      ...
      <title> Admin Panel | Add Notice</title>
...
<tr bgcolor="black">
<th colspan="7"><h2><center>ADD NOTICE</center></h2></th>
</tr></table></center>
    ...
    <label for="title"><b>Notice Title</b></label>&nbsp;&nbsp;&nbsp;&nbsp;<br />
    <asp:TextBox
    ...
    <asp:TextBox ID="TextBox2"   
          runat="server" ForeColor="Black" Width="734px" TextMode="MultiLine"></asp:TextBox>
  ...
  <center><asp:Calendar ID="Calendar1" runat="server"></asp:Calendar></center> 
    ...
    <asp:Button ID="Button1" runat="server" Text="Add Notice" BackColor="#094987" 
