<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="add_employee.aspx.cs" Inherits="Hospital_Management_System.add_employee" %>
...
<tr bgcolor="black">
<th colspan="7"><h2><center>ADD EMPLOYEE FORM</center></h2></th>
</tr></table></center>
    ...
    <asp:TextBox
        ID="TextBox1" runat="server"  ForeColor="Black" ></asp:TextBox>
        <br />
      
      <br />

      <label for="gender"><b>Gender</b></label>
    <asp:RadioButton ID="RadioButton1" runat="server" GroupName="gender" Text="Female"></asp:RadioButton>
    <asp:RadioButton ID="RadioButton2" runat="server" GroupName="gender" Text="Male"></asp:RadioButton>
    ...
    <asp:TextBox
        ID="TextBox3" runat="server"  ForeColor="Black" ></asp:TextBox>
        <br />
    ...
    <label for="address"><b>Address</b></label>
      <br />
    <asp:TextBox
        ID="TextBox4" runat="server"  ForeColor="Black" TextMode="MultiLine" 
          Height="52px" Width="100%"></asp:TextBox>
        <br />
      
      <br />
      <label for="qualification"><b>Designation</b></label>
    ...
    <label for="specialisation_in"><b>Department</b></label>
    <asp:TextBox
        ID="TextBox6" runat="server"  ForeColor="Black" ></asp:TextBox>
        <br />
    ...
    <asp:Button ID="Button2" runat="server" Text="Add Employee" BackColor="#094987" 
          ForeColor="White" Height="52px" Width="100%" onclick="Button2_Click"  />
