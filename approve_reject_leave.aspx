<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="approve_reject_leave.aspx.cs" Inherits="Hospital_Management_System.approve_reject_leave" %>
...
<head>
      ...
      <title> Admin Panel | Approve/Reject Leave</title>
...
<tr bgcolor="black">
<th colspan="7"><h2><center>APPROVE AND REJECT LEAVES</center></h2></th>
</tr></table></center>
    ...
    <label for="id"><b>DOCTOR ID</b></label><br />
    <asp:TextBox ID="TextBox1"   
          runat="server" ForeColor="Black" Width="734px" Enabled="False"></asp:TextBox>
        <br />
  ...
  <asp:DropDownList ID="DropDownList1" runat="server" Width="734px" AutoPostBack="true">
    ...
    <asp:Button ID="Button1" runat="server" Text="Update Reports" BackColor="#094987" 
